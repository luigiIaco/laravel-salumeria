    ...
    <div class="card scale-in p-4 shadow-lg" style="max-width: 500px; margin: 0 auto;">
        ...
        <form method="POST" action="{{ route('paymentForm') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="card_holder" class="form-control" placeholder="Mario Rossi" name="holder" required>
            </div>
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <input type="text" id="exp_month" class="form-control" maxlength="2" minlength="2" placeholder="MM" name="exp_month" required>
                </div>
                <div class="col-4">
                    <label class="form-label">Anno</label>
                    <input type="text" id="exp_year" class="form-control" maxlength="2" placeholder="YY" name="exp_year" required>
                </div>
                <div class="col-4">
                    <label class="form-label">CVV</label>
                    <input type="text" id="cvv" class="form-control" maxlength="3" placeholder="123" name="cvv" required>
                </div>
            </div>

            <div class="mt-3">
                <label class="form-label">Importo (€)</label>
                <input type="number" step="0.01" id="amount" class="form-control text-center" value="10.00" disabled>
            </div>
